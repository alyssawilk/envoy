...
TEST_P(AlpnIntegrationTest, Http2) {
  ...
  protocols_ = {Http::CodecType::HTTP2, FakeHttpConnection::Type::HTTP2};
  initialize();
...
TEST_P(AlpnIntegrationTest, Http1) {
  ...
  protocols_ = {Http::CodecType::HTTP1, FakeHttpConnection::Type::HTTP1};
  initialize();
...
TEST_P(AlpnIntegrationTest, Mixed) {
  protocols_ = {Http::CodecType::HTTP1, FakeHttpConnection::Type::HTTP2};
  initialize();
